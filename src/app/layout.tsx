...
export const metadata: Metadata = {
  title: "Brew & Bean Coffee Shop - Premium Coffee Experience",
  description: "Discover exceptional coffee, cozy atmosphere, and friendly service at Brew & Bean. Premium beans, expert baristas, and community focus since 2018.",
  keywords: "coffee shop, premium coffee, barista, espresso, cappuccino, coffee beans, cafe",
  ...
  openGraph: {
    ...
    images: [{
      ...
      alt: "Intimate cafe setting with a neon sign reading 'All you need is love (and cake)'"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Brew & Bean Coffee Shop - Premium Coffee Experience",
    description: "Discover exceptional coffee, cozy atmosphere, and friendly service at Brew & Bean.",
